# Generated by Django 4.0 on 2022-01-06 16:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Tag', models.CharField(choices=[('BR', 'Завтрак'), ('LU', 'Обед'), ('DN', 'Ужин')], max_length=2)),
                ('time_cooking', models.SmallIntegerField(verbose_name='Время приготовления (мин)')),
